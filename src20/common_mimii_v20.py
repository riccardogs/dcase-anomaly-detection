"""
@file   common_mimii_v20.py
@brief  Common utilities with normalization
"""
...
logging.basicConfig(level=logging.DEBUG, filename="baseline_mimii_v20.log")
...
def yaml_load():
    with open("baseline_mimii_v20.yaml") as stream:
...
def file_to_vector_array(file_name, n_mels=128, frames=5, n_fft=1024, hop_length=512, power=2.0):
    """Convert audio file to log-mel spectrogram vector array"""
    dims = n_mels * frames
...
class Normalizer:
    """Per-feature normalizer with mean and std"""
...
def get_machine_dirs(base_dir):
    """Get all machine directories with train/ folder"""
