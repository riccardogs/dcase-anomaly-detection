"""
@file   01_test_mimii_v20.py
@brief  Test with Hybrid V2 - Normalized + Multi-score
"""
...
print("=" * 60)
print("MODEL 20 - HYBRID V2 EVALUATION")
print("=" * 60)
...
def compute_anomaly_score_hybrid(model, data):
    """
    Multi-component anomaly score:
    - MSE medio (stabile)
    - Max error (cattura picchi)
    - Percentile 95 (robusto)
    """
    ...
    # Combined score (pesi bilanciati)
...
if __name__ == "__main__":
    ...
    for idx, target_dir in enumerate(machine_dirs):
        ...
        # Calcola AUC se disponibile ground truth
